...
public class lihatKategoriBarang extends javax.swing.JFrame {
    ControllerKategori cKategori;
    
    /**
     * Creates new form lihatKategoriBarang
     */
    public lihatKategoriBarang() {
        initComponents();
        this.setLocationRelativeTo(null);
        cKategori = new ControllerKategori(this);
        cKategori.loadTableKategoriBarang();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lihatKategoriBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lihatKategoriBarang().setVisible(true);
            }
        });
    }
